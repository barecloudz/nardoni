        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div className="text-center max-w-4xl mx-auto" initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="flex justify-center">
              <Link href="/book-a-call?service=social"><Button size="lg" className="bg-pink-600 hover:bg-pink-700 text-white px-10 py-6 text-lg rounded-full">Get Started<ArrowRight className="ml-2 h-5 w-5" /></Button></Link>
            </div>
          </motion.div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-br from-pink-600 to-rose-600">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div className="text-center max-w-3xl mx-auto" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            ...
            <Link href="/book-a-call?service=social"><Button size="lg" className="text-lg px-10 py-6 h-auto bg-white text-pink-600 hover:bg-gray-100 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 rounded-full"><span>Get Started Today</span><ArrowRight className="ml-2 h-5 w-5" /></Button></Link>
          </motion.div>
        </div>
      </section>
