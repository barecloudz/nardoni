...
const SEOLocalSearch: React.FC = () => {
  const faqs = [
    ...
    },
    {
      ...
      answer: "If we haven't gotten you onto the first page of Google within 90 days, we keep working for free until we do. Simple as that."
    },
    {
    ...
    },
    {
      ...
      answer: "You're never locked in. It's $500 per month and you can cancel anytime. No annual contracts, no hidden commitments."
    },
    {
          ...
          <div className="max-w-5xl mx-auto space-y-8">
            {[
              ...
              },
              {
                ...
                description: "Most businesses we work with start climbing within the first few weeks. If we haven't gotten you to the first page of Google within 90 days, we keep working for free until we do."
              },
              {
                number: '4',
                icon: Target,
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <motion.div className="text-center max-w-4xl mx-auto" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <div className="inline-block bg-white/20 backdrop-blur-sm border-2 border-white/40 rounded-full px-6 py-3 mb-6">
              <span className="text-white font-bold text-lg">$500/Month • Results Guaranteed</span>
            </div>
