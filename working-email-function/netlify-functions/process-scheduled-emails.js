...
// NOTE: Update this HTML template with your company branding
        ...
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          <tr>
            <td style="background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%); padding: 32px; text-align: center;">
              ...
              <p style="margin: 8px 0 0 0; color: #fecaca; font-size: 14px;">Your Tagline</p>
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td style="background-color: #f9fafb; padding: 24px 32px; border-top: 1px solid #e5e7eb; text-align: center;">
              <p style="margin: 0 0 4px 0; color: #6b7280; font-size: 13px;">📍 Your Address Here</p>
              <p style="margin: 0; color: #6b7280; font-size: 13px;">📞 Your Phone Number</p>
            </td>
          </tr>
        </table>
      </td>
