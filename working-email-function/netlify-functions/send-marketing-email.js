...
export async function handler(event, context) {
  ...
  try {
    const { to, subject, body, attachments = [], attachmentUrls = [], useHtmlTemplate = false } = JSON.parse(event.body);
    ...
    <tr>
      <td align="center">
        <table width="100%" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
          ...
          <!-- Header - UPDATE THIS WITH YOUR BRANDING -->
          <tr>
            <td style="background: linear-gradient(135deg, #dc2626 0%, #b91c1c 100%); padding: 32px; text-align: center;">
              <h1 style="margin: 0; color: #ffffff; font-size: 24px; font-weight: bold;">Your Company Name</h1>
              <p style="margin: 8px 0 0 0; color: #fecaca; font-size: 14px;">Your Tagline Here</p>
            </td>
          </tr>
          ...
          <!-- Footer - UPDATE THIS WITH YOUR INFO -->
          <tr>
                ...
                <tr>
                  <td style="text-align: center;">
                    <p style="margin: 0 0 8px 0; color: #6b7280; font-size: 14px;">
                      <strong style="color: #374151;">Your Company Name</strong>
                    </p>
